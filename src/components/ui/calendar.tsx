  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-gray-100/50 aria-selected:text-muted-foreground aria-selected:opacity-30 dark:aria-selected:bg-gray-800/50 dark:aria-selected:text-gray-400",
